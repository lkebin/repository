...
func (r *userRepositoryImpl) FindAll(ctx context.Context) ([]*testdata.User, error) {
	var m []*testdata.User
...
func (r *userRepositoryImpl) FindById(ctx context.Context, id int64) (*testdata.User, error) {
	var m testdata.User
