...
func (r *userUuidRepositoryImpl) DeleteById(ctx context.Context, id repository.ID) error {
...
func (r *userUuidRepositoryImpl) ExistsById(ctx context.Context, id repository.ID) (bool, error) {
	var cnt int64
...
func (r *userUuidRepositoryImpl) FindAll(ctx context.Context) ([]*testdata.UserUuid, error) {
...
func (r *userUuidRepositoryImpl) FindById(ctx context.Context, id repository.ID) (*testdata.UserUuid, error) {
	var m testdata.UserUuid
